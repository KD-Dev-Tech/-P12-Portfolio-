                ...
                <div className="row">
                    <div className="col-md-4 mb-5 text-center">
                        ...
                        <div className='container-img_skill'>
                            <img className='img-fluid' src="../public/assets/JS.webp" alt="JavaScript Logo" />
                            <img className='img-fluid' src="../public/assets/React.webp" alt="React Logo" />
                            <img className='img-fluid rounded' src="../public/assets/Bootstrap.webp" alt="Bootstrap Logo" />
                            <img className='img-fluid rounded' src="../public/assets/Redux.webp" alt="Redux Logo" />
                            <img className='img-fluid rounded' src="../public/assets/Sass.webp" alt="Sass Logo" />                        
                        </div>
                    </div>
                    <div className="col-md-4 mb-5 text-center">
                        ...
                        <div className='container-img_skill'>
                            <img className='img-fluid rounded' src="../public/assets/NodeJs.webp" alt="Node.js Logo" />
                        </div>
                    </div>
                    <div className="col-md-4 mb-5 text-center">
                        ...
                        <div className='container-img_skill'>
                            <img className='img-fluid ' src="../public/assets/MongoDB.webp" alt="MongoDB Logo" />
                            <img className='img-fluid ' src="../public/assets/Swagger.webp" alt="Swagger Logo" />
                        </div>
                    </div>
                    <div className="col-md-4 mb5 text-center">
                        ...
                        <div className='container-img_skill'>
                            <img className='img-fluid rounded' src="../public/assets/Git.webp" alt="" />
                            <img className='img-fluid rounded' src="../public/assets/Chatgpt.webp" alt="" />
                            <img className='img-fluid rounded' src="../public/assets/Figma.webp" alt="" />
                        </div>
                    </div>
                </div>
            </div>
